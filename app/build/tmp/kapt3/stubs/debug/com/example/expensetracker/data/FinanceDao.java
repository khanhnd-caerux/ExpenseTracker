...
public abstract interface FinanceDao {
    ...
    @androidx.room.Query(value = "SELECT * FROM user WHERE id = 0 LIMIT 1")
    @org.jetbrains.annotations.Nullable
    public abstract com.example.expensetracker.data.User getUser();
    
    @androidx.room.Insert(onConflict = 1)
    public abstract void insertUser(@org.jetbrains.annotations.NotNull
    com.example.expensetracker.data.User user);
}